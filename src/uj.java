...
/**
 * Servlet implementation class uj
 */
@WebServlet("/uj")
public class uj extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			con=(Connection) DriverManager.getConnection(URL,"root","shrikara");
			smt=con.prepareStatement("insert into job(jnm,jdesc) values(?,?)");
			...
			smt.setString(1, sub);
     		...
     		if(v==1)
     		{
     			out.println("<h1>JOB successfully UPLOADED</h1><br/><a href admin.html>HOME?</a>");
     		}
		}
		catch(Exception e)
		{
